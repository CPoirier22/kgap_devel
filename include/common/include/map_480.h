 ...
 * Remarks :
 *
 * $Header: /services/syncdata/hazelaar/8500/server_vault/applab/phldrv/sw/gik/inc/sc14480_userdefined.h.rca 1.1 Mon Apr 16 10:50:26 2007 roovers Experimental roovers $
 * $Date: Mon Apr 16 10:50:26 2007 $
 *
 * $Id: sc14480_userdefined.h.rca 1.1 Mon Apr 16 10:50:26 2007 roovers Experimental roovers $
 *
 * $Log: sc14480_userdefined.h.rca $
 *
 *  Revision: 1.1 Mon Apr 16 10:50:26 2007 roovers
 *  Updated phldrv with pp_wb_sc14450_lmx4180, fp_sc14480_intlmx4180,
 *  and pp_sc14480_intlmx4180
 *
 *
 */
...
/* LED Controls for "ICU KT2580 Evaluation Board"*/
/* D1 P0(4)*/
#define INIT_LED_D1  P0_MODE_REG &= ~P0_4_MODE;\
                     P0_DIR_REG  &= ~(3<<8)

#define LED_D1_RED   P0_RESET_DATA_REG  =  BIT4;\
                     P0_DIR_REG  |=  (3<<8)

#define LED_D1_GREEN P0_SET_DATA_REG  =  BIT4;\
                     P0_DIR_REG  &= ~(3<<8)

#define LED_D1_BOTH  P0_SET_DATA_REG  =  BIT4;\
                     P0_DIR_REG  |=  (3<<8)

/* D2 P0(6)*/
#define INIT_LED_D2  P0_MODE_REG &= ~P0_6_MODE;\
                     P0_DIR_REG  &= ~(3<<12)

#define LED_D2_RED   P0_RESET_DATA_REG  =  BIT6;\
                     P0_DIR_REG  |=  (3<<12)

#define LED_D2_GREEN P0_SET_DATA_REG  =  BIT6;\
                     P0_DIR_REG  &= ~(3<<12)

#define LED_D2_BOTH  P0_SET_DATA_REG  =  BIT6;\
                     P0_DIR_REG  |= (3<<12)

/* D3 P2(5)*/
#define INIT_LED_D3  P2_MODE_REG &= ~P2_5_MODE;\
                     P2_DIR_REG  &= ~(3<<10)

#define LED_D3_RED   P2_RESET_DATA_REG  =  BIT5;\
                     P2_DIR_REG  |=  (3<<10)

#define LED_D3_GREEN P2_SET_DATA_REG  =  BIT5;\
                     P2_DIR_REG  &= ~(3<<10)

#define LED_D3_BOTH P2_SET_DATA_REG  =  BIT5;\
                     P2_DIR_REG  |=  (3<<10)


/* D4 P2(2)*/
#define INIT_LED_D4  P2_MODE_REG &= ~P2_2_MODE;\
                     P2_DIR_REG  &= ~(3<<4)

#define LED_D4_RED   P2_RESET_DATA_REG  =  BIT2;\
                     P2_DIR_REG  |=  (3<<4)

#define LED_D4_GREEN P2_SET_DATA_REG  =  BIT2;\
                     P2_DIR_REG  &= ~(3<<4)

#define LED_D4_BOTH  P2_SET_DATA_REG  =  BIT2;\
                     P2_DIR_REG  |=  (3<<4)

/* D5 P2(3)*/
#define INIT_LED_D5  P2_MODE_REG &= ~P2_3_MODE;\
                     P2_DIR_REG  &= ~(3<<6)

#define LED_D5_RED   P2_RESET_DATA_REG = BIT3;\
                     P2_DIR_REG  |=  (3<<6)

#define LED_D5_GREEN P2_SET_DATA_REG = BIT3;\
                     P2_DIR_REG  &= ~(3<<6)

#define LED_D5_BOTH  P2_SET_DATA_REG = BIT3;\
                     P2_DIR_REG  |=  (3<<6)

/* D6 P2(4)*/
#define INIT_LED_D6  P2_MODE_REG &= ~P2_4_MODE;\
                     P2_DIR_REG  &=  ~(3<<8)

#define LED_D6_RED   P2_RESET_DATA_REG = BIT4;\
                     P2_DIR_REG  |=  (3<<8)

#define LED_D6_GREEN P2_SET_DATA_REG = BIT4;\
                     P2_DIR_REG  &= ~(3<<8)

#define LED_D6_BOTH  P2_SET_DATA_REG = BIT4;\
                     P2_DIR_REG  |=  (3<<8)


/* D7 P1(0)*/
#define INIT_LED_D7  P1_MODE_REG &= ~P1_0_MODE;\
                     P1_DIR_REG  &= ~(3<<0);

#define LED_D7_RED   P1_RESET_DATA_REG  =  BIT0;\
                     P1_DIR_REG  |=  (3<<0)

#define LED_D7_GREEN P1_SET_DATA_REG  = BIT0;\
                     P1_DIR_REG  &= ~(3<<0)

#define LED_D7_BOTH  P1_SET_DATA_REG  = BIT0;\
                     P1_DIR_REG  |=  (3<<0)
...
/* Software interrupts*/
#define DIP_RECV_INT        (MODEL*30)  /* DIP receive slot interrupt */

#define RAM_START                               (0x008000)  /*  */
#define RAM_END                                 (0x009FFF)  /*  */
#define SHARED_RAM_START_ADDRESS                (0x010000)  /*  */
...
__no_init volatile uint16 CLK_AMBA_REG             @ 0xFF4000; /* HCLK, PCLK, divider and clock gates*/
#define CLK_AMBA_REG_ADDR                            0xFF4000
__no_init volatile uint16 CLK_CODEC_DIV_REG        @ 0xFF4002; /* Codec divider register*/
__no_init volatile uint16 CLK_CODEC_REG            @ 0xFF4004; /* Codec clock selection register*/
__no_init volatile uint16 CLK_DSP_REG              @ 0xFF4006; /* DSP clock selection register*/
__no_init volatile uint16 CLK_FREQ_TRIM_REG        @ 0xFF400A; /* Xtal frequency trimming register.*/
#define CLK_FREQ_TRIM_REG_ADDR                       0xFF400A
__no_init volatile uint16 CLK_PER_DIV_REG          @ 0xFF400C; /* Peripheral divider register for 2,1, 1/2, 1/4 MHz clocks*/
__no_init volatile uint16 CLK_PER10_DIV_REG        @ 0xFF400E; /* Peripheral divider register for 20, 10 MHz clocks*/
__no_init volatile uint16 CLK_PLL_CTRL_REG         @ 0xFF4010; /* PLL control register*/
__no_init volatile uint16 CLK_PLL_DIV_REG          @ 0xFF4012; /* PLL divider register*/
__no_init volatile uint16 CLK_XTAL_CTRL_REG        @ 0xFF4018; /* Crystal, PLL control register*/
__no_init volatile uint16 CLK_AUX_REG              @ 0xFF401A; /* Auxiliary clock control register*/
__no_init volatile uint16 DMA0_A_STARTL_REG        @ 0xFF4400; /* Start address Low A of DMA channel 0*/
__no_init volatile uint16 DMA0_A_STARTH_REG        @ 0xFF4402; /* Start address Low A of DMA channel 0*/
__no_init volatile uint16 DMA0_B_STARTL_REG        @ 0xFF4404; /* Start address Low B of DMA channel 0*/
__no_init volatile uint16 DMA0_B_STARTH_REG        @ 0xFF4406; /* Start address High B of DMA channel 0*/
__no_init volatile uint16 DMA0_INT_REG             @ 0xFF4408; /* DMA receive interrupt register channel 0*/
__no_init volatile uint16 DMA0_LEN_REG             @ 0xFF440A; /* DMA receive length register channel 0*/
__no_init volatile uint16 DMA0_CTRL_REG            @ 0xFF440C; /* Control register for the DMA channel 0*/
__no_init volatile uint16 DMA0_IDX_REG             @ 0xFF440E; /* Internal Index register for the DMA channel 0*/
__no_init volatile uint16 DMA1_A_STARTL_REG        @ 0xFF4410; /* Start address Low A of DMA channel 1*/
__no_init volatile uint16 DMA1_A_STARTH_REG        @ 0xFF4412; /* Start address High A of DMA channel 1*/
__no_init volatile uint16 DMA1_B_STARTL_REG        @ 0xFF4414; /* Start address Low B of DMA channel 1*/
__no_init volatile uint16 DMA1_B_STARTH_REG        @ 0xFF4416; /* Start address High B of DMA channel 1*/
__no_init volatile uint16 DMA1_INT_REG             @ 0xFF4418; /* DMA receive interrupt register channel 1*/
__no_init volatile uint16 DMA1_LEN_REG             @ 0xFF441A; /* DMA receive length register channel 1*/
__no_init volatile uint16 DMA1_CTRL_REG            @ 0xFF441C; /* Control register for the DMA channel 1*/
__no_init volatile uint16 DMA1_IDX_REG             @ 0xFF441E; /* Internal Index register for the DMA channel 1*/
__no_init volatile uint16 DMA2_A_STARTL_REG        @ 0xFF4420; /* Start address Low A of DMA channel 2*/
__no_init volatile uint16 DMA2_A_STARTH_REG        @ 0xFF4422; /* Start address High A of DMA channel 2*/
__no_init volatile uint16 DMA2_B_STARTL_REG        @ 0xFF4424; /* Start address Low B of DMA channel 2*/
__no_init volatile uint16 DMA2_B_STARTH_REG        @ 0xFF4426; /* Start address High B of DMA channel 2*/
__no_init volatile uint16 DMA2_INT_REG             @ 0xFF4428; /* DMA receive interrupt register channel 2*/
__no_init volatile uint16 DMA2_LEN_REG             @ 0xFF442A; /* DMA receive length register channel 2*/
__no_init volatile uint16 DMA2_CTRL_REG            @ 0xFF442C; /* Control register for the DMA channel 2*/
__no_init volatile uint16 DMA2_IDX_REG             @ 0xFF442E; /* Internal Index register for the DMA channel 2*/
__no_init volatile uint16 DMA3_A_STARTL_REG        @ 0xFF4430; /* Start address Low A of DMA channel 3*/
__no_init volatile uint16 DMA3_A_STARTH_REG        @ 0xFF4432; /* Start address High A of DMA channel 3*/
__no_init volatile uint16 DMA3_B_STARTL_REG        @ 0xFF4434; /* Start address Low B of DMA channel 3*/
__no_init volatile uint16 DMA3_B_STARTH_REG        @ 0xFF4436; /* Start address High B of DMA channel 3*/
__no_init volatile uint16 DMA3_INT_REG             @ 0xFF4438; /* DMA receive interrupt register channel 3*/
__no_init volatile uint16 DMA3_LEN_REG             @ 0xFF443A; /* DMA receive length register channel 3*/
__no_init volatile uint16 DMA3_CTRL_REG            @ 0xFF443C; /* Control register for the DMA channel 3*/
__no_init volatile uint16 DMA3_IDX_REG             @ 0xFF443E; /* Internal Index register for the DMA channel 3*/
__no_init volatile uint16 TEST_ENV_REG             @ 0xFF4800; /* CR16Cplus boot mode control register*/
__no_init volatile uint16 TEST_CTRL_REG            @ 0xFF4802; /* Test control register, shall not be modified*/
__no_init volatile uint16 TEST_CTRL2_REG           @ 0xFF4804; /* Test control register 2, shall not be modified*/
__no_init volatile uint16 BANDGAP_REG              @ 0xFF4810; /* Bandgap register*/
#define BANDGAP_REG_ADDR                             0xFF4810
__no_init volatile uint16 BAT_CTRL_REG             @ 0xFF4812; /* Power management control register*/
__no_init volatile uint16 BAT_CTRL2_REG            @ 0xFF4814; /* Power charge control register*/
__no_init volatile uint16 BAT_STATUS_REG           @ 0xFF4816; /* Power status register*/
__no_init volatile uint16 BAT_SOC_HIGH_REG         @ 0xFF4818; /* Power state of charge counter (high)*/
__no_init volatile uint16 BAT_SOC_LOW_REG          @ 0xFF481A; /* Power state of charge counter (low)*/
__no_init volatile uint16 CP_CTRL_REG              @ 0xFF481C; /* Charge pump for LEDs control register.*/
__no_init volatile uint16 PAD_CTRL_REG             @ 0xFF481E; /* PAD control register*/
__no_init volatile uint16 P0_DATA_REG              @ 0xFF4830; /* P0 Data register*/
__no_init volatile uint16 P0_SET_DATA_REG          @ 0xFF4832; /* P0 set port pins register*/
__no_init volatile uint16 P0_RESET_DATA_REG        @ 0xFF4834; /* P0 reset port pins register*/
__no_init volatile uint16 P0_DIR_REG               @ 0xFF4836; /* P0 direction register*/
__no_init volatile uint16 P0_MODE_REG              @ 0xFF4838; /* P0 Mode register*/
__no_init volatile uint16 P1_DATA_REG              @ 0xFF4840; /* P1 Data register*/
__no_init volatile uint16 P1_SET_DATA_REG          @ 0xFF4842; /* P1 set port pins register*/
__no_init volatile uint16 P1_RESET_DATA_REG        @ 0xFF4844; /* P1 reset port pins register*/
__no_init volatile uint16 P1_DIR_REG               @ 0xFF4846; /* P1 direction register*/
__no_init volatile uint16 P1_MODE_REG              @ 0xFF4848; /* P1 Mode register*/
__no_init volatile uint16 P2_DATA_REG              @ 0xFF4850; /* P2 Data register*/
__no_init volatile uint16 P2_SET_DATA_REG          @ 0xFF4852; /* P2 set port pins register*/
__no_init volatile uint16 P2_RESET_DATA_REG        @ 0xFF4854; /* P2 reset port pins register*/
__no_init volatile uint16 P2_DIR_REG               @ 0xFF4856; /* P2 direction register*/
__no_init volatile uint16 P2_MODE_REG              @ 0xFF4858; /* P2 Mode register*/
__no_init volatile uint16 P3_DATA_REG              @ 0xFF4860; /* P3 Data register*/
__no_init volatile uint16 P3_SET_DATA_REG          @ 0xFF4862; /* P3 set port pins register*/
__no_init volatile uint16 P3_RESET_DATA_REG        @ 0xFF4864; /* P3 reset port pins register*/
__no_init volatile uint16 P3_DIR_REG               @ 0xFF4866; /* P3 direction register*/
__no_init volatile uint16 P3_MODE_REG              @ 0xFF4868; /* P3 Mode register*/
__no_init volatile uint16 P5_DIR_REG               @ 0xFF4876;

__no_init volatile uint16 UART_CTRL_REG            @ 0xFF4900; /* UART control register*/
__no_init volatile uint16 UART_RX_TX_REG           @ 0xFF4902; /* UART data transmit/receive register*/
__no_init volatile uint16 UART_CLEAR_TX_INT_REG    @ 0xFF4904; /* UART clear transmit interrupt*/
__no_init volatile uint16 UART_CLEAR_RX_INT_REG    @ 0xFF4906; /* UART clear receive interrupt*/
__no_init volatile uint16 UART_ERROR_REG           @ 0xFF4908; /* UART Parity error register*/
__no_init volatile uint16 ACCESS1_IN_OUT_REG       @ 0xFF4920; /* ACCESS bus 1 receive/transmit register*/
__no_init volatile uint16 ACCESS1_CTRL_REG         @ 0xFF4922; /* ACCESS bus 1 Control register*/
__no_init volatile uint16 ACCESS1_CLEAR_INT_REG    @ 0xFF4924; /* Clear ACCESS bus 1 interrupt*/
__no_init volatile uint16 ACCESS2_IN_OUT_REG       @ 0xFF4930; /* ACCESS bus 2 receive/transmit register*/
__no_init volatile uint16 ACCESS2_CTRL_REG         @ 0xFF4932; /* ACCESS bus 2 Control register*/
__no_init volatile uint16 ACCESS2_CLEAR_INT_REG    @ 0xFF4934; /* Clear ACCESS bus 2 interrupt*/
__no_init volatile uint16 SPI_CTRL_REG             @ 0xFF4940; /* SPI control register*/
__no_init volatile uint16 SPI_RX_TX_REG0           @ 0xFF4942; /* SPI RX/TX register0*/
__no_init volatile uint16 SPI_RX_TX_REG1           @ 0xFF4944; /* SPI RX/TX register1*/
__no_init volatile uint16 SPI_CLEAR_INT_REG        @ 0xFF4946; /* SPI clear interrupt register*/
__no_init volatile uint16 ADC_CTRL_REG             @ 0xFF4960; /* ADC control register*/
__no_init volatile uint16 ADC_CTRL1_REG            @ 0xFF4962; /* ADC control register 1*/
__no_init volatile uint16 ADC_CLEAR_INT_REG        @ 0xFF4964; /* Clears ADC interrupt if set in ADC_CTRL_REG*/
__no_init volatile uint16 ADC0_REG                 @ 0xFF4966; /* ADC0 result register*/
__no_init volatile uint16 ADC1_REG                 @ 0xFF4968; /* ADC1 result registers*/
__no_init volatile uint16 TIMER_CTRL_REG           @ 0xFF4970; /* Timers control registers*/
__no_init volatile uint16 TIMER0_ON_REG            @ 0xFF4972; /* Timers 0 on control registers*/
__no_init volatile uint16 TIMER0_RELOAD_M_REG      @ 0xFF4974; /**/
__no_init volatile uint16 TIMER0_RELOAD_N_REG      @ 0xFF4976; /**/
__no_init volatile uint16 TIMER1_RELOAD_M_REG      @ 0xFF4978; /**/
__no_init volatile uint16 TIMER1_RELOAD_N_REG      @ 0xFF497A; /**/
__no_init volatile uint16 TIMER2_DUTY1_REG         @ 0xFF497C; /* Timer2 duty cycle for PWM1*/
__no_init volatile uint16 TIMER2_DUTY2_REG         @ 0xFF497E; /* Timer2 duty cycle for PWM 2*/
__no_init volatile uint16 TIMER2_FREQ_REG          @ 0xFF4980; /* Timer2 frequency prescaler*/
__no_init volatile uint16 TONE_CTRL1_REG           @ 0xFF4990; /* Capture timer control register 1*/
__no_init volatile uint16 TONE_COUNTER1_REG        @ 0xFF4992; /* Capture timer Counter 1*/
__no_init volatile uint16 TONE_LATCH1_REG          @ 0xFF4994; /* Capture timer Latch 1*/
__no_init volatile uint16 TONE_CLEAR_INT1_REG      @ 0xFF4996; /* Clears CT1 interrupt and TONE_LATCH1_REG*/
__no_init volatile uint16 TONE_CTRL2_REG           @ 0xFF4998; /* Capture timer control register 2*/
__no_init volatile uint16 TONE_COUNTER2_REG        @ 0xFF499A; /* Capture timer Counter 2*/
__no_init volatile uint16 TONE_LATCH2_REG          @ 0xFF499C; /* Capture timer Latch 2*/
__no_init volatile uint16 TONE_CLEAR_INT2_REG      @ 0xFF499E; /* Clears CT2 interrupt and TONE_LATCH2_REG*/
__no_init volatile uint16 KEY_GP_INT_REG           @ 0xFF49B0; /* General purpose interrupts for KEYB_INT*/
__no_init volatile uint16 KEY_BOARD_INT_REG        @ 0xFF49B2; /* Keyboard interrupt enable register*/
__no_init volatile uint16 KEY_DEBOUNCE_REG         @ 0xFF49B4; /* Keyboard debounce and auto key generation timer*/
__no_init volatile uint16 KEY_STATUS_REG           @ 0xFF49B6; /* Keyboard interrupt status.*/
__no_init volatile uint16 WATCHDOG_REG             @ 0xFF4C00; /* Watchdog preset value.*/
__no_init volatile uint16 SET_FREEZE_REG           @ 0xFF5000; /* Freeze watchdog, timer1 and DIP during debugging*/
#define SET_FREEZE_REG_ADDR                          0xFF5000

__no_init volatile uint16 RESET_FREEZE_REG         @ 0xFF5002; /* Release watchdog, timer1 and DIP during debugging after setting in freeze mode*/
__no_init volatile uint16 DEBUG_REG                @ 0xFF5004; /* DEBUG_REG for boot program control and debug control*/
__no_init volatile uint16 MEM_CONF_REG             @ 0xFF5006; /* Memory configuration register*/
__no_init volatile uint16 TRACE_CTRL_REG           @ 0xFF5020; /* Trace control register*/
__no_init volatile uint16 TRACE_STATUS_REG         @ 0xFF5022; /* Trace status register*/
__no_init volatile uint16 TRACE_START0_REG         @ 0xFF5024; /* Trace start register 0*/
__no_init volatile uint16 TRACE_LEN0_REG           @ 0xFF5026; /* Trace length register 0*/
__no_init volatile uint16 TRACE_START1_REG         @ 0xFF5028; /* Trace start register 1*/
__no_init volatile uint16 TRACE_LEN1_REG           @ 0xFF502A; /* Trace length register 1*/
__no_init volatile uint16 TRACE_TIMERL_REG         @ 0xFF502C; /* Trace timer bits 15-0*/
__no_init volatile uint16 TRACE_TIMERH_REG         @ 0xFF502E; /* Trace timer bits 31-16*/
__no_init volatile uint16 SET_INT_PENDING_REG      @ 0xFF5400; /* Set interrupt pending register*/
__no_init volatile uint16 RESET_INT_PENDING_REG    @ 0xFF5402; /* Reset interrupt pending register*/
__no_init volatile uint16 INT0_PRIORITY_REG        @ 0xFF5404; /* Interrupt priority register 0*/
__no_init volatile uint16 INT1_PRIORITY_REG        @ 0xFF5406; /* Interrupt priority register 1*/
__no_init volatile uint16 INT2_PRIORITY_REG        @ 0xFF5408; /* Interrupt priority register 2*/
__no_init volatile uint16 INT3_PRIORITY_REG        @ 0xFF540A; /* Interrupt priority register 2*/
__no_init volatile uint16 PC_START_REG             @ 0xFF540C; /* CR16Cplus startup address*/
__no_init volatile uint16 CODEC_MIC_REG            @ 0xFF5800; /* Codec microphone control register*/
__no_init volatile uint16 CODEC_LSR_REG            @ 0xFF5802; /* Codec loudspeaker control register*/
__no_init volatile uint16 CODEC_VREF_REG           @ 0xFF5804; /* Codec vref control register*/
__no_init volatile uint16 CODEC_TONE_REG           @ 0xFF5806; /* Codec CID control register*/
__no_init volatile uint16 CODEC_ADDA_REG           @ 0xFF5808; /* Codec ad/da control register*/
__no_init volatile uint16 CODEC_OFFSET1_REG        @ 0xFF580A; /* Codec offset error and compensation register*/
__no_init volatile uint16 CODEC_TEST_CTRL_REG      @ 0xFF580C; /* Codec test control register codec*/
__no_init volatile uint16 CODEC_OFFSET2_REG        @ 0xFF580E; /* Codec offset compensation register*/
__no_init volatile uint16 CLASSD_CTRL_REG          @ 0xFF5C00; /* Class D control register*/
__no_init volatile uint16 CLASSD_CLEAR_INT_REG     @ 0xFF5C02; /* Class D Clear interrupt register*/
__no_init volatile uint16 CLASSD_BUZZER_REG        @ 0xFF5C04; /* Class D buzzer register*/
__no_init volatile uint16 CLASSD_TEST_REG          @ 0xFF5C06; /* Class D test register*/
__no_init volatile uint16 CLASSD_NR_REG            @ 0xFF5C08; /* Class D noise reduction register*/
__no_init volatile uint16 DIP_STACK_REG            @ 0xFF6000; /* DIP Stack pointer. (read only). The DIP stack is 4 deep*/
__no_init volatile uint16 DIP_PC_REG               @ 0xFF6002; /* DIP program counter*/
__no_init volatile uint16 DIP_STATUS_REG           @ 0xFF6004; /* DIP Status register,*/
#define DIP_STATUS_REG_ADDR                          0xFF6004
__no_init volatile uint16 DIP_CTRL_REG             @ 0xFF6006; /* DIP Control register1*/
#define DIP_CTRL_REG_ADDR                            0xFF6006
__no_init volatile uint16 DIP_STATUS1_REG          @ 0xFF6008; /* DIP Status register1,*/
__no_init volatile uint16 DIP_CTRL1_REG            @ 0xFF600A; /* DIP Control register, clears DIP_INT if read*/
__no_init volatile uint16 DIP_SLOT_NUMBER_REG      @ 0xFF600C; /* DIP slot number register, returns the current slot number*/
__no_init volatile uint16 DIP_CTRL2_REG            @ 0xFF600E; /* DIP Control register 2 (debug status information)*/
__no_init volatile uint16 DIP_MOD_SEL_REG          @ 0xFF6012; /* DIP Modulo counters selection*/
__no_init volatile uint16 DIP_MOD_VAL_REG          @ 0xFF6014; /* DIP Modulo values selection*/
__no_init volatile uint16 BMC_CTRL_REG             @ 0xFF6400; /* BMC control register*/
__no_init volatile uint16 BMC_CTRL2_REG            @ 0xFF6402; /* BMC control register 2*/
__no_init volatile uint16 BMC_TX_SFIELDL_REG       @ 0xFF6404; /* BMC Tx S field register Low*/
__no_init volatile uint16 BMC_TX_SFIELDH_REG       @ 0xFF6406; /* BMC Tx S field register High*/
__no_init volatile uint16 BMC_RX_SFIELDL_REG       @ 0xFF6408; /* BMC Rx S field register Low*/
__no_init volatile uint16 BMC_RX_SFIELDH_REG       @ 0xFF640A; /* BMC Rx S field register High*/
__no_init volatile uint16 RF_BURST_MODE_CTRL_REG   @ 0xFF7000; /* BMCW*/
__no_init volatile uint16 RF_ALW_EN_REG            @ 0xFF7008; /* always-enable bits for block activation*/
__no_init volatile uint16 RF_PORT_RSSI_SI_REG      @ 0xFF700A; /* SO_PORT/EO_RSSI switch instant settings*/
__no_init volatile uint16 RF_TX_SI_REG             @ 0xFF700C; /* TX switch instant settings*/
__no_init volatile uint16 RF_RX_SI_REG             @ 0xFF700E; /* RX switch instant settings*/
__no_init volatile uint16 RF_PORT1_DCF_REG         @ 0xFF7010; /* Port 1 dynamic control function settings*/
__no_init volatile uint16 RF_PORT2_DCF_REG         @ 0xFF7012; /* Port 2 dynamic control function settings*/
__no_init volatile uint16 RF_PORT3_DCF_REG         @ 0xFF7014; /* Port 3 dynamic control function settings*/
__no_init volatile uint16 RF_PORT4_DCF_REG         @ 0xFF7016; /* Port 4 dynamic control function settings*/
__no_init volatile uint16 RF_PLLCLOSED_DCF_REG     @ 0xFF7018; /* PLL closed loop dynamic control function*/
__no_init volatile uint16 RF_SYNTH_DCF_REG         @ 0xFF701A; /* voltage-controlled oscillator dynamic control function*/
__no_init volatile uint16 RF_BIAS_DCF_REG          @ 0xFF701C; /* bias circuit dynamic control function*/
__no_init volatile uint16 RF_RSSIPH_DCF_REG        @ 0xFF701E; /* RSSI peak-hold computation dynamic control function*/
__no_init volatile uint16 RF_DEM_DCF_REG           @ 0xFF7020; /* demodulator dynamic control function*/
__no_init volatile uint16 RF_ADC_DCF_REG           @ 0xFF7022; /* analog-to-digital converter dynamic control function*/
__no_init volatile uint16 RF_IF_DCF_REG            @ 0xFF7024; /* intermediate-frequency filter dynamic control function*/
__no_init volatile uint16 RF_LNAMIX_DCF_REG        @ 0xFF7026; /* low-noise amplifier and mixer dynamic control function*/
__no_init volatile uint16 RF_PADR_DCF_REG          @ 0xFF7028; /* PA driver dynamic control function*/
__no_init volatile uint16 RF_FAD_WINDOW_DCF_REG    @ 0xFF702A; /* FAD timing control function*/
__no_init volatile uint16 RF_RFCAL_CTRL_REG        @ 0xFF7040; /* RF calibration control settings*/
__no_init volatile uint16 RF_DEM_CTRL_REG          @ 0xFF7044; /* demodulator control settings*/
__no_init volatile uint16 RF_PREAMBLE_REG          @ 0xFF7046; /* preamble-processing control settings*/
__no_init volatile uint16 RF_RSSI_REG              @ 0xFF7048; /* received-signal strength indication value, FAD choice and RF calibration result*/
__no_init volatile uint16 RF_PORT_CTRL_REG         @ 0xFF704A; /* port control settings*/
__no_init volatile uint16 RF_PAD_IO_REG            @ 0xFF704C; /* disable digital input/output on RFPORTs*/
__no_init volatile uint16 RF_TRIM_CTRL_REG         @ 0xFF704E; /* production trimming of PADR output power*/
__no_init volatile uint16 RF_PLL_CTRL1_REG         @ 0xFF7050; /* PLL control settings for frequency calculation*/
__no_init volatile uint16 RF_PLL_CTRL2_REG         @ 0xFF7052; /* PLL control settings for frequency calculation*/
#define RF_PLL_CTRL2_REG_ADDR                        0xFF7052
__no_init volatile uint16 RF_PLL_CTRL3_REG         @ 0xFF7054; /* PLL control settings for frequency calculation*/
__no_init volatile uint16 RF_PLL_CTRL4_REG         @ 0xFF7056; /* PLL control settings for frequency calculation*/
#define RF_PLL_CTRL4_REG_ADDR                        0xFF7056
__no_init volatile uint16 RF_SLICER_REG            @ 0xFF7058; /* RX active slicer settings*/
__no_init volatile uint16 RF_SLICER_RESULT_REG     @ 0xFF705A; /* Results computed by RX active slicer*/
__no_init volatile uint16 RF_GAUSS_GAIN_RESULT_REG @ 0xFF705C; /* Result of modulation-gain calibration*/
__no_init volatile uint16 RF_BURST_MODE_SHADOW1_REG@ 0xFF7070; /* BMCW shadow register*/
#define RF_BURST_MODE_SHADOW1_REG_ADDR               0xFF7070; /* BMCW shadow register*/
__no_init volatile uint16 RF_BURST_MODE_SHADOW2_REG@ 0xFF7072; /* BMCW shadow register*/
#define RF_BURST_MODE_SHADOW2_REG_ADDR               0xFF7072
__no_init volatile uint16 RF_DCF_MONITOR_REG       @ 0xFF7074; /* To monitor DCF strobes to GPIO pins*/
__no_init volatile uint16 RF_SYNTH_CTRL1_REG       @ 0xFF7080; /**/
__no_init volatile uint16 RF_SYNTH_CTRL2_REG       @ 0xFF7082; /**/
__no_init volatile uint16 RF_AGC_REG               @ 0xFF7084; /**/
__no_init volatile uint16 RF_AGC12_TH_REG          @ 0xFF7086; /**/
__no_init volatile uint16 RF_AGC12_ALPHA_REG       @ 0xFF7088; /**/
__no_init volatile uint16 RF_DC_OFFSET_REG         @ 0xFF708C; /**/
__no_init volatile uint16 RF_DC_OFFSET34_REG       @ 0xFF708E; /**/
__no_init volatile uint16 RF_IQ_DC_OFFSET_REG      @ 0xFF7090; /**/
__no_init volatile uint16 RF_IF_CTRL_REG           @ 0xFF7092; /**/
__no_init volatile uint16 RF_REF_OSC_REG           @ 0xFF7094; /**/
__no_init volatile uint16 RF_ADC_CTRL_REG          @ 0xFF7096; /**/
__no_init volatile uint16 RF_RFIO_CTRL_REG         @ 0xFF7098; /**/
__no_init volatile uint16 RF_BIAS_CTRL_REG         @ 0xFF709A; /**/
__no_init volatile uint16 RF_DRIFT_TEST_REG        @ 0xFF709C; /**/
__no_init volatile uint16 RF_TEST_MODE_REG         @ 0xFF709E; /**/
__no_init volatile uint16 RF_LDO_TEST_REG          @ 0xFF70A0; /**/
__no_init volatile uint16 RF_PLL_CTRL5_REG         @ 0xFF70AC; /**/
#define RF_PLL_CTRL5_REG_ADDR                        0xFF70AC
__no_init volatile uint16 RF_PLL_CTRL6_REG         @ 0xFF70AE; /**/
__no_init volatile uint16 RF_INTERNALPA_REG        @ 0xFF70B0; /**/
__no_init volatile uint16 RF_PA_RESERVED1_REG      @ 0xFF70B2; /**/
__no_init volatile uint16 RF_PA_RESERVED2_REG      @ 0xFF70B4; /**/
__no_init volatile uint16 RF_IFCAL_RESULT_REG      @ 0xFF70B6; /**/
__no_init volatile uint16 RF_DC_OFFSET12_REG       @ 0xFF70B8; /**/
__no_init volatile uint16 RF_AGC_RESULT_REG        @ 0xFF70BA; /**/
__no_init volatile uint16 RF_GAUSS_GAIN_MSB_REG    @ 0xFF70BC; /**/
__no_init volatile uint16 FLASH_CTRL_REG           @ 0xFF7400; /* Flash control register*/
__no_init volatile uint16 FLASH_PTNVH1_REG         @ 0xFF7402; /* Flash NVSTR hold time (mass erase)*/
__no_init volatile uint16 FLASH_PTPROG_REG         @ 0xFF7404; /* Flash program time*/
__no_init volatile uint16 FLASH_PTERASE_REG        @ 0xFF7406; /* Flash erase time (page)*/
__no_init volatile uint16 FLASH_PTME_REG           @ 0xFF7408; /* Flash erase time (mass)*/
__no_init volatile uint8  CHIP_ID1_REG             @ 0xFFFBF8; /* Chip identification register 1*/
__no_init volatile uint8  CHIP_ID2_REG             @ 0xFFFBF9; /* Chip identification register 2*/
__no_init volatile uint8  CHIP_ID3_REG             @ 0xFFFBFA; /* Chip identification register 3*/
__no_init volatile uint8  CHIP_MEM_SIZE_REG        @ 0xFFFBFB; /* Chip memory size register*/
__no_init volatile uint8  CHIP_REVISION_REG        @ 0xFFFBFC; /* Chip revision register (Correspond to Chip Marking)*/
__no_init volatile uint8  CHIP_TEST1_REG           @ 0xFFFBFD; /* Chip test register*/
__no_init volatile uint8  CHIP_TEST2_REG           @ 0xFFFBFE; /* Chip test register*/

extern __data24 uint16* DSP_MAIN_SYNC0_REG;
#define DSP_MAIN_SYNC0_REG_ADDR                            0x1027F80
/*__no_init volatile uint16 DSP_MAIN_SYNC0_REG       @ 0x1027F80; // DSP main counter outputs selection register 0*/

extern __data24 uint16* DSP_MAIN_SYNC1_REG;
#define DSP_MAIN_SYNC1_REG_ADDR                            0x1027F82
/* __no_init volatile uint16 DSP_MAIN_SYNC1_REG       @ 0x1027F82; // DSP main counter outputs selection register 1*/

/* __no_init volatile uint16 DSP_MAIN_CNT_REG         @ 0x1027F84; // DSP main counter reload register*/
#define DSP_MAIN_CNT_REG_ADDR 0x1027F84; /* DSP main counter reload register*/
__no_init volatile uint16 DSP_ADC0S_REG            @ 0x1027F86; /* ADC0 Input 2's Complement register*/
__no_init volatile uint16 DSP_ADC1S_REG            @ 0x1027F88; /* ADC1 Input 2's Complement register*/
__no_init volatile uint16 DSP_CLASSD_REG           @ 0x1027F8A; /* CLASSD Output output data register*/
__no_init volatile uint16 DSP_CODEC_MIC_GAIN_REG   @ 0x1027F8C; /* CODEC MIC GAIN register*/
/* __no_init volatile uint16 DSP_CODEC_OUT_REG        @ 0x1027F8E; // CODEC DATA register*/
#define DSP_CODEC_OUT_REG_ADDR 0x1027F8E; /* CODEC DATA register*/
/* __no_init volatile uint16 DSP_CODEC_IN_REG         @ 0x1027F90; // CODEC DATA register*/
#define DSP_CODEC_IN_REG_ADDR 0x1027F90; /* CODEC DATA register*/
__no_init volatile uint16 DSP_RAM_OUT0_REG         @ 0x1027F92; /* Shared RAM output register 0*/
__no_init volatile uint16 DSP_RAM_OUT1_REG         @ 0x1027F94; /* Shared RAM output register 1*/
__no_init volatile uint16 DSP_RAM_OUT2_REG         @ 0x1027F96; /* Shared RAM output register 2*/
__no_init volatile uint16 DSP_RAM_OUT3_REG         @ 0x1027F98; /* Shared RAM output register 3*/
/* __no_init volatile uint16 DSP_RAM_IN0_REG          @ 0x1027F9A; // Shared RAM input register 0*/
#define DSP_RAM_IN0_REG_ADDR 0x1027F9A;
__no_init volatile uint16 DSP_RAM_IN1_REG          @ 0x1027F9C; /* Shared RAM input register 1*/
__no_init volatile uint16 DSP_RAM_IN2_REG          @ 0x1027F9E; /* Shared RAM input register 2*/
__no_init volatile uint16 DSP_RAM_IN3_REG          @ 0x1027FA0; /* Shared RAM input register 3*/
__no_init volatile uint16 DSP_ZCROSS1_OUT_REG      @ 0x1027FA2; /* ZERO CROSSING 1 output register*/
__no_init volatile uint16 DSP_ZCROSS2_OUT_REG      @ 0x1027FA4; /* ZERO CROSSING 2 output register*/
__no_init volatile uint16 DSP_PCM_OUT0_REG         @ 0x1027FA6; /* PCM channel 0 output register*/
__no_init volatile uint16 DSP_PCM_OUT1_REG         @ 0x1027FA8; /* PCM channel 1 output register*/
__no_init volatile uint16 DSP_PCM_OUT2_REG         @ 0x1027FAA; /* PCM channel 2 output register*/
__no_init volatile uint16 DSP_PCM_OUT3_REG         @ 0x1027FAC; /* PCM channel 3 output register*/
/*__no_init volatile uint16 DSP_PCM_IN0_REG          @ 0x1027FAE; // PCM channel 0 input register*/
#define DSP_PCM_IN0_REG_ADDR 0x1027FAE; /* PCM channel 0 input register*/
/*__no_init volatile uint16 DSP_PCM_IN1_REG          @ 0x1027FB0; // PCM channel 1 input register*/
#define DSP_PCM_IN1_REG_ADDR 0x1027FB0; /* PCM channel 1 input register*/
/* __no_init volatile uint16 DSP_PCM_IN2_REG          @ 0x1027FB2; // PCM channel 2 input register*/
#define DSP_PCM_IN2_REG_ADDR 0x1027FB2; /* PCM channel 2 input register*/
/* __no_init volatile uint16 DSP_PCM_IN3_REG          @ 0x1027FB4; // PCM channel 3 input register*/
#define DSP_PCM_IN3_REG_ADDR 0x1027FB4; /* PCM channel 3 input register*/
/* __no_init volatile uint16 DSP_PCM_CTRL_REG         @ 0x1027FB6; // PCM Control register*/
#define DSP_PCM_CTRL_REG_ADDR 0x1027FB6;
__no_init volatile uint16 DSP_PHASE_INFO_REG       @ 0x1027FB8; /* Phase information between PCM FSC 8/16/32 and main counter 8/16/32 kHz*/
__no_init volatile uint16 DSP_VQI_REG              @ 0x1027FBA; /* BCM VQI register*/

extern __data24 uint16* DSP_MAIN_CTRL_REG;
#define DSP_MAIN_CTRL_REG_ADDR                            0x1027FBC
/* __no_init volatile uint16 DSP_MAIN_CTRL_REG        @ 0x1027FBC; // DSP Main counter control and preset value*/

__no_init volatile uint16 DSP_CLASSD_BUZZOFF_REG   @ 0x1027FBE; /* CLASSD Buzzer on/off controller, bit 15*/

extern __data24 uint16* DSP_CTRL_REG;
#define DSP_CTRL_REG_ADDR                            0x1027FD0
/*__no_init volatile uint16 DSP_CTRL_REG           @ 0x1027FD0; // DSP control register*/

extern  __data24 uint16* DSP_PC_REG;
#define DSP_PC_REG_ADDR                              0x1027FD2
/*__no_init volatile uint16 DSP_PC_REG             @ 0x1027FD2; // DSP Programma counter*/

extern  __data24 uint16* DSP_PC_START_REG;
#define DSP_PC_START_REG_ADDR                        0x1027FD4
/* __no_init volatile uint16 DSP_PC_START_REG      @ 0x1027FD4; // DSP Programma counter start*/

/* __no_init volatile uint16 DSP_IRQ_START_REG        @ 0x1027FD6; // DSP Interrupt vector start*/
#define DSP_IRQ_START_REG_ADDR 0x1027FD6; /* DSP Interrupt vector start*/
/* __no_init volatile uint16 DSP_INT_REG              @ 0x1027FD8; // DSP to CR16Cplus interrupt vector*/
#define DSP_INT_REG_ADDR 0x1027FD8; /* DSP to CR16Cplus interrupt vector*/
/* __no_init volatile uint16 DSP_INT_MASK_REG         @ 0x1027FDA; // DSP to CR16Cplus interrupt vector maks*/
#define DSP_INT_MASK_REG_ADDR 0x1027FDA; /* DSP to CR16Cplus interrupt vector maks*/

extern  __data24 uint16* DSP_INT_PRIO1_REG;
#define DSP_INT_PRIO1_REG_ADDR                        0x1027FDC
/*__no_init volatile uint16 DSP_INT_PRIO1_REG        @ 0x1027FDC; // DSP Interrupt source mux 1 register*/

extern  __data24 uint16* DSP_INT_PRIO2_REG;
#define DSP_INT_PRIO2_REG_ADDR                        0x1027FDE
/* __no_init volatile uint16 DSP_INT_PRIO2_REG        @ 0x1027FDE; // DSP Interrupt source mux2 register*/

__no_init volatile uint16 DSP_OVERFLOW_REG         @ 0x1027FE0; /* DSP to CR16Cplus overflow register*/
__no_init volatile uint16 DBG_IREG                 @ 0x1027FF0; /* DSP JTAG instruction register*/
__no_init volatile uint16 DBG_INOUT_REG_LSW        @ 0x1027FF4; /**/
__no_init volatile uint16 DBG_INOUT_REG_MSW        @ 0x1027FF6; /**/
...
#define  RxSynthesisValue_Byte2(chan) (0x00)
#define  RxSynthesisValue_Byte3(chan) (chan+18+DECT_Channel_offset)

#define  TxSynthesisValue_Byte1(chan) (0x01)
#define  TxSynthesisValue_Byte2(chan) (0x00)
#define  TxSynthesisValue_Byte3(chan) (chan+18+DECT_Channel_offset)

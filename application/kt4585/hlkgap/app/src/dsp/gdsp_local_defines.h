...
#define DSP_SEGMENT_SIZE        	0x1A0C	// was 0x1E00; subtracted 0x428 after removing PAEC, 0x80 after adding message repeater, 0x4C after adding 2nd base, added 0x100 after moving iStack
